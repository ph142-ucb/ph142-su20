...
check_problem2 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = all.equal(p_value, 0.0017, .001),
             correct_message = "Correct answer!",
             error_message = "Round to at least three decimals. Make sure the answer is between 0 and 1.")
...
check_problem3 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = all.equal(p_value_using_code, 0.0017, tol = .001),
             correct_message = "Correct answer",
             error_message = "Round to at least three decimals. Does this match your answer to problem 2?")
...
check_problem5 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = all.equal(p_value_chisq, 0.0017, tol = .001),
             correct_message = "Correct answer",
             error_message = "Round to at least three decimals. Does this match your answer to problem 3?")
