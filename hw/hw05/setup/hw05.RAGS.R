#################################################
# Autograder tests for PH142 hw05-normal-binomial
...
check_problem2 = function() {
  ...
  checkpoint(checkpoint_number = 2,
             test = p2[1] > 0.96 && p2[1] <0.98, 
             correct_message = "Passed checkpoint for probability!",
             error_message = "Incorrect number answer for part a.")
  checkpoint(checkpoint_number = 3,
             test =  p2[2] > 0 && p2[2] < 0.1,
             correct_message = "Passed checkpoint for absolute difference!",
             error_message = "Did you take the absolute difference?"
            )
...
check_problem3 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = is.numeric(p3_lower_bound) & is.numeric(p3_upper_bound), 
             correct_message = "You created two numeric objects!",
             error_message = "Make sure you made two numeric objects.")
  
  checkpoint(checkpoint_number = 2,
             test = p3_lower_bound < 70, 
             correct_message = "Passed checkpoint for lower bound!",
             error_message = "Incorect range. Check your answer.")
  checkpoint(checkpoint_number = 3,
             test =  p3_upper_bound > 70,
             correct_message = "Passed checkpoint for upper bound!",
             error_message = "Incorrect range. Check your answer."
  )
