...
ASSIGNMENT_RMD_PATH = "hw01"
COURSE_ID = 137452
PROGRAMMING_ASSIGNMENT_ID = 546334
FRQ_ASSIGNMENT_ID = 546326 # only for HW's, comment out for labs
FRQ_Q_NUMS = [16] # questions to be exported as FRQ (only for HW's)
