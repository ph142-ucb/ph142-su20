...
COURSE_ID = 137452
PROGRAMMING_ASSIGNMENT_ID = 576659
FRQ_ASSIGNMENT_ID = 576657 # only for HW's, comment out for labs
FRQ_Q_NUMS = [2, 3, 5, 8, 11] # questions to be exported as FRQ (only for HW's)
