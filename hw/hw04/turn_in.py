...
ASSIGNMENT_RMD_PATH = "hw04.Rmd"
COURSE_ID = 137452
PROGRAMMING_ASSIGNMENT_ID = 561634
FRQ_ASSIGNMENT_ID = 561635 # only for HW's, comment out for labs
FRQ_Q_NUMS = [1, 5, 9, 10, 11, 13] # questions to be exported as FRQ (only for HW's)
