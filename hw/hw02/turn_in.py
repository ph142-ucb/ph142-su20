...
ASSIGNMENT_RMD_PATH = "hw02.Rmd"
COURSE_ID = 137452
PROGRAMMING_ASSIGNMENT_ID = 553412
FRQ_ASSIGNMENT_ID = 553414 # only for HW's, comment out for labs
FRQ_Q_NUMS = [4, 9, 10, 15] # questions to be exported as FRQ (only for HW's)
