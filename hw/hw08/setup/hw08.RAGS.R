...
check_problem4 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             ...
             error_message = "Is your upperbound a numeric value.")
  
  checkpoint(checkpoint_number = 2,
             test = class(CI_lowerbound)=="numeric",
             correct_message = "Passed.",
             error_message = "Is your lowerbound a numeric value."
  )
...
check_problem7 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             ...
             correct_message = "Passed.",
             error_message = "Did you input a numeric value?.")
  
  checkpoint(checkpoint_number = 2,
             test = round(p_value, 2) < 0.1,
             correct_message = "Passed.",
             error_message = "Not in the correct range. Check your work."
  )
...
check_problem10 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = p10 == "Both a 95% CI and a 99% CI will contain 0." |
