...
ASSIGNMENT_RMD_PATH = "hw06.Rmd"
COURSE_ID = 137452
PROGRAMMING_ASSIGNMENT_ID = 569167
FRQ_ASSIGNMENT_ID = 569165 # only for HW's, comment out for labs
FRQ_Q_NUMS = [3, 4, 6, 9, 10, 11, 14, 15, 17, 18, 21, 22] # questions to be exported as FRQ (only for HW's)
