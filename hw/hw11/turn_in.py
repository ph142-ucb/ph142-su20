...
COURSE_ID = 137452
PROGRAMMING_ASSIGNMENT_ID = 587208
FRQ_ASSIGNMENT_ID = 587211 # only for HW's, comment out for labs
FRQ_Q_NUMS = [1, 3, 9, 10, 15, 16, 19, 20, 23] # questions to be exported as FRQ (only for HW's)
